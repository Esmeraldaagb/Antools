      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className='text-lg font-medium my-3'>Copyright 2021. Antools</p>
          ...
          <div>
            <h4 className="font-bold mb-4 text-white text-2xl">
              Contact Us
            </h4>
            <ul className="space-y-2 text-white/55 text-lg font-medium">
              <li>+621454859</li>
